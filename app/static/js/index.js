 ...
 */
(function () {
    const msgs = document.querySelector("#msg-box");
...
(function () {
    ...
    const main = new Program(canvas, gl, new Map([["a_position", [3, Float32Array.BYTES_PER_ELEMENT]],
    ...
    const pick = new Picker(canvas, gl, new Map([["a_position", [3, Float32Array.BYTES_PER_ELEMENT]]]), new Map([
        ["vp", (program, data) => gl.uniformMatrix4fv(gl.getUniformLocation(program, "u_vp"), false, data)],
    ...
    const shapes = [
        ...
        new Shape(gl, gl.LINES, createGrid(1, 1, 0.1, [160, 117, 206]), 7),
    ];
    ...
    // Handle recenter
    document.querySelector("#canvas-box #center")
        .addEventListener("pointerdown", () => {
        main.x = 0;
        main.y = 0;
        main.draw();
    ...
    // Handle help
    const msg = document.querySelector("#canvas-box .msg");
    let stage = -1;
